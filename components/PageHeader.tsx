        ...
        <div className="flex items-center space-x-4 py-4 px-4 sm:px-8 h-16 w-full sticky top-0 left-0 bg-sdark-base bg-opacity-50">
            ...
            {isLoggedIn && variant === 'playlist' && (
                <div className={`${true && 'grow'} text-white flex items-center space-x-4`}>
                    <button className="bg-sgreen-100 h-12 w-12 rounded-full flex items-center justify-center hover:scale-105">
            ...
            {isLoggedIn ? (
                <div>
                    <button className="flex items-center space-x-2 text-white text-sm font-bold rounded-full bg-black p-[2px] md:pr-2">
                        <div className="flex items-center h-7 w-7 justify-center rounded-full bg-[#535353]">
                ...
                <div className="flex items-center space-x-6">
                    <button className="text-white font-bold opacity-80 hover:opacity-100 hover:scale-105">
                        <p>Sign up</p>
                    </button>
